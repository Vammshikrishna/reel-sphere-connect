-- Fix the get_user_conversations_with_profiles function to use recipient_id instead of receiver_id
-- This fixes the bug where the previous migration script referenced a non-existent column
