...
const Navbar = () => {
  ...
  return <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-card border-b border-border shadow-sm transition-theme">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex items-center justify-between py-3 sm:py-4">
            {/* Logo */}
            <Link to="/" className="flex items-center flex-shrink-0 group">
              <Film className="h-6 w-6 sm:h-8 sm:w-8 text-primary mr-2 group-hover:scale-110 transition-transform duration-200" />
              <span className="text-lg sm:text-2xl font-bold text-gradient whitespace-nowrap">
                <span className="hidden sm:inline">CineCraft Connect</span>
